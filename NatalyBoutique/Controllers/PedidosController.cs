...
namespace NatalyBoutique.Controllers
{
    public class PedidosController : Controller
    {
        ...
        public PedidosController(NatalyBoutiqueContext context)
        {
            _context = context;
        }
        ...
        {
            var natalyBoutiqueContext = _context.Pedidos.Include(p => p.IdClienteNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdPedidos,IdCliente,Fecha,CantidadPedido")] Pedidos pedidos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPedidos,IdCliente,Fecha,CantidadPedido")] Pedidos pedidos)
        {
